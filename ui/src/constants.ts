...
export const XAI_API_URL = import.meta.env.VITE_XAI_API_URL || 'http://localhost:31313' // `${window.location.protocol}//${window.location.hostname}:31030/`
export const XAI_API_HEALTH_CHECK_INTERVAL_MS = 1000 * 60
export const XAI_API_INFO_CHECK_INTERVAL_MS = 1000 * 60
export const OLLAMA_API_URL = import.meta.env.VITE_OLLAMA_API_URL  || 'http://localhost:31313/ai/gateway/ollama/' // || `${window.location.protocol}//${window.location.hostname}:31030/ai/gateway/ollama/`;
