...
docker run -it --rm --name geenii -v $(pwd)/.geenii:/.geenii geenii/geenii:latest

# Run the container with data persistence
cd working-directory
docker run -it --rm --name geenii -v $(pwd)/data:/data -v $(pwd)/.geenii:/.geenii geenii/geenii:latest
```
...
```bash
alias xgeenii='docker run -it --rm --name geenii -v $(pwd)/data:/data -v $(pwd)/.geenii:/.geenii geenii/geenii:latest geenii'
alias xgeeniimod='docker run -it --rm --name geeniimod -v $(pwd)/data:/data -v $(pwd)/.geenii:/.geenii geenii/geenii:latest geeniimod'
alias xgeenii-update='docker pull docker.io/fmlabs/geenii:latest'

# Now you can use `geenii` and `geeniimod` commands directly in your terminal, and the data will be persisted in the `data` folder.
xgeenii-update
xgenii --help
xgeeniimod --help
```
...
docker run -it --rm --name geenii -v geenii_data:/data -v $(pwd)/.geenii:/.geenii geenii/geenii:latest
```